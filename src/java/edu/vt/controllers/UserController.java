...
public class UserController implements Serializable {
    ...
    **************************************
    ...
    /*
    ******************************************
    Return CC Expiration Date as e.g. May 2023
    ******************************************
     */
    public String ccExpirationMonthYear() {
        /*
        substring(int indexNumber1, int indexNumber2): 
        Returns a string containing all the characters at 
        indexNumber1 to (indexNumber2 - 1).
        "MMYY" --> index numbers 0,1,2,3
         */

        String monthNumberString = selected.getCcExpires().substring(0, 2);
        int monthNumber = Integer.parseInt(monthNumberString);

        String monthName = "";
        DateFormatSymbols dfs = new DateFormatSymbols();
        
        // getMonths() returns a String array of month names from 0 to 11
        String[] months = dfs.getMonths();
        monthName = months[monthNumber - 1];
        
        String yearTwoNumbers = selected.getCcExpires().substring(2, 4);

        return monthName + " 20" + yearTwoNumbers;
    }
    ...
    **********************************************************
    ...
    public String createAccount() {
        ...
        try {
            ...
            newUser.setCcExpires(ccExpires);
            newUser.setCcSecurityCode(ccSecurityCode);
    ...
    ***********************************************************
    ...
    public String updateAccount() {
        ...
        try {
            ...
            editUser.setCcExpires(this.selected.getCcExpires());
            editUser.setCcSecurityCode(this.selected.getCcSecurityCode());
