...
public final class Constants {
    ...
    public static final String PHOTOS_ABSOLUTE_PATH = "C:/Users/Balci/DocRoot/PizzaHutStorage/";
    ...
    to allow our application to read and write files external to (outside of) its deployed directory.
        ...
        <property name="alternatedocroot_1" value="from=/PizzaHutStorage/* dir=/Users/Balci/DocRoot" />
    ...
    *       implies that you can put directories and files within the /PizzaHutStorage/ top directory.
    ...
    tag <h> automatically inserts the app name, e.g., /PizzaHut-Balci, before the relative path.
    Then, for example, when
    
        /PizzaHut-Balci/PizzaHutStorage/defaultUserPhoto.png
    
    is processed by GlassFish, GlassFish knows because of the glassfish-web.xml file that the
    DocRoot is "/Users/Balci/DocRoot" for the app named PizzaHut-Balci and replaces the app name with
    DocRoot to obtain the absolute path to the file, 
    
        /Users/Balci/DocRoot/PizzaHutStorage/defaultUserPhoto.png
    ...
    #{facesContext.externalContext.requestContextPath} returns 
        <> the app name starting with slash, e.g., /PizzaHut-Balci, if an external file is referenced or
        <> the URI of the Web Pages folder of the application if an internal file is referenced.
     */
    public static final String PHOTOS_RELATIVE_PATH = "/CloudListStorage/";
    public static final String DEFAULT_PHOTO_RELATIVE_PATH = "/CloudListStorage/defaultUserPhoto.png";
